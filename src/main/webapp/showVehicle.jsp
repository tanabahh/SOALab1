...
<form action = "${pageContext.request.contextPath}/vehicle" method="get">
    ...
    <input type="number" name="perPage" placeholder="На страницу">
    <input type="text" name="sortState" placeholder="Парметры сортировки в формате column&true,..">
    <input type="text" name="id" placeholder="id =">
    <input type="text" name="name" placeholder="name =">
    <input type="text" name="creationDate" placeholder="creationDate =">
    <input type="text" name="enginePower" placeholder="enginePower =">
    ...
    <c:forEach items="${vehicle}" var = "vehicle">
        <tr>
            ...
            <td>
                ...
                <form action="deleteVehicle.jsp" method="post">
                    <input type="hidden" name="id" value="${vehicle.getId()}">
...
<form action = "${pageContext.request.contextPath}/extra/deleteWithEnginePower" method="post">
    <input type="text" name="enginePower" placeholder="enginePower =">
...
<form action = "${pageContext.request.contextPath}/extra/getMaxCreatingDateServlet" method="get">
    <input type="submit" value="Получить">
</form>

Сгруппировать по creatingDate и вернуть количество элементов
<form action = "${pageContext.request.contextPath}/extra/groupByCreationDate" method="get">
